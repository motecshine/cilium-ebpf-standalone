...
MAX_LB_OPTIONS += -DLB_SELECTION=1 -DLB_SELECTION_MAGLEV=1 -DENABLE_IPSEC=1
endif

ifndef MAX_OVERLAY_OPTIONS
MAX_OVERLAY_OPTIONS = $(MAX_BASE_OPTIONS) -DENCAP_IFINDEX=1 -DTUNNEL_MODE=1 -DENABLE_MULTICAST=1
MAX_OVERLAY_OPTIONS += -DLB_SELECTION=1 -DLB_SELECTION_MAGLEV=1 -DENABLE_IPSEC=1
ifeq ($(KERNEL),netnext)
...
HOST_OPTIONS = $(LXC_OPTIONS) \
	...
	-DDISABLE_LOOPBACK_LB:-DENABLE_IPV4:-DENABLE_IPV6:-DENCAP_IFINDEX:-DTUNNEL_MODE:-DPOLICY_VERDICT_NOTIFY:-DENABLE_NODEPORT:-DENABLE_MASQUERADE_IPV4:-DENABLE_IP_MASQ_AGENT_IPV4:-DENABLE_MASQUERADE_IPV6:-DENABLE_IP_MASQ_AGENT_IPV6: \
	...
	-DDISABLE_LOOPBACK_LB:-DENABLE_IPV6:-DENCAP_IFINDEX:-DTUNNEL_MODE:-DPOLICY_VERDICT_NOTIFY:-DENABLE_NODEPORT:-DENABLE_NODEPORT_ACCELERATION:-DENABLE_DSR:-DENABLE_DSR_HYBRID:-DENABLE_PREFILTER:-DENABLE_SESSION_AFFINITY:-DENABLE_HOST_FIREWALL:-DENABLE_ICMP_RULE:-DENABLE_SRV6:-DENABLE_MULTICAST:-DENCRYPTED_OVERLAY: \
...
ifeq ($(KERNEL),netnext)
MAX_WIREGUARD_OPTIONS += -DENABLE_HIGH_SCALE_IPCACHE=1
endif
endif

XDP_OPTIONS = $(LB_OPTIONS) \
	-DDISABLE_LOOPBACK_LB:-DENABLE_IPV4:-DENABLE_IPV6:-DENABLE_DSR:-DFROM_HOST: \
	-DDISABLE_LOOPBACK_LB:-DENABLE_NODEPORT_ACCELERATION:-DENABLE_IPV4:-DENABLE_IPV6:-DENABLE_NODEPORT:-DENABLE_MASQUERADE_IPV4:-DENABLE_IP_MASQ_AGENT_IPV4:-DENABLE_MASQUERADE_IPV6:-DENABLE_IP_MASQ_AGENT_IPV6: \
...
LXC_OPTIONS = \
	 ...
	 -DENABLE_IPV4:-DENABLE_IPV6:-DENCAP_IFINDEX:-DENABLE_TPROXY:-DENABLE_HOST_ROUTING:-DENABLE_SKIP_FIB:-DENABLE_ICMP_RULE:-DENABLE_SCTP:-DENABLE_HIGH_SCALE_IPCACHE:-DENABLE_IPSEC: \
...
$(foreach OPTS,$(WIREGUARD_OPTIONS),$(eval $(call PERMUTATION_template,bpf_wireguard.o,$(OPTS) -DENCAP_IFINDEX=1 -DDIRECT_ROUTING_DEV_IFINDEX=0)))
